    ...
    try:
        ...
        if topic == "中国古诗":
            mock_outline = (
                ...
                "从《诗经》到宋诗的千年演进\n\n"
                "## 诗歌的起源：劳动与祭祀\n"
                "中国古诗起源于先秦时期，最初与劳动生产和宗教祭祀密切相关。\n\n"
                "### 早期诗歌形态：\n"
                "* **劳动歌谣**：协调动作、减轻疲劳，如《弹歌》“断竹，续竹，飞土，逐肉”\n"
                "* **祭祀颂歌**：用于宗庙祭祀，表达对祖先和神灵的敬畏\n"
                "* **《诗经》的诞生**：中国第一部诗歌总集，收录西周初年至春秋中叶305首诗歌\n\n"
                "### 历史意义：\n"
                "《诗经》奠定了中国诗歌现实主义传统，开创了“赋、比、兴”的表现手法，对后世影响深远。"
            )
    ...
    try:
        ...
        if "中国古诗" in topic:
            mock_slides = [
                {
                    "title": "中国古诗",
                    "points": ["千年文脉，诗意永恒", "汇报人：文化研究部", "汇报时间：2026年7月9日"],
                    "narration": "同学们好！今天我们来学习关于中国古诗的精彩内容。中国古典诗歌传承千年，凝聚了历代文人墨客的深邃智慧与审美情趣，是中华文化宝库中的璀璨明珠。让我们开始今天的诗意探索旅程。"
                },
                {
                    "title": "目录",
                    "points": [
                    ...
                    "narration": "首先我们来看一下课程的大纲目录。本次课将从诗歌起源与历史演进脉络展开，详细剖析先秦两汉、魏晋南北朝、唐宋时期的诗歌风貌，并学习古诗的核心艺术特色与其在现代社会中的传承价值。"
                },
                {
                    "title": "中国古诗的起源与发展脉络",
                    "points": ["从《诗经》到宋诗的千年演进"],
                    "narration": "今天我们要探讨的第一章是：中国古诗的起源与发展脉络。从先秦的四言诗到汉乐府五言律诗的成型，再到盛唐气象与宋代深思意境，中国古诗历经千年演变，孕育了无数名篇名句，是中国文学长河中最绚丽的浪花。"
                },
                {
                    "title": "诗歌的起源：劳动与祭祀",
                    "points": [
                        ...
                        "早期诗歌形态：",
                        "  - 劳动歌谣：协调动作、减轻疲劳，如《弹歌》“断竹，续竹，飞土，逐肉”",
                        "  - 祭祀颂歌：用于宗庙祭祀，表达对对祖先和神灵的敬畏",
                        "  - 《诗经》的诞生：中国第一部诗歌总集，收录西周初年至春秋中叶305首诗歌",
                        "历史意义：《诗经》奠定了中国诗歌现实主义传统，开创了“赋、比、兴”的表现手法，对后世影响深远。"
                    ],
                    "narration": "中国古典诗歌起源于先秦时期，最初源自先民的劳动生产与祭祀活动。当时口口相传的劳动歌谣用来减轻疲劳，例如古老的《弹歌》；而祭祀颂歌则用于在宗庙中敬畏神灵。《诗经》的诞生更是中国诗歌史上的里程碑，收录了西周至春秋的305首诗歌，开创了赋比兴手法，深刻影响了后世两千年的现实主义文学传统。"
                }
            ]
            return jsonify({'success': True, 'slides': mock_slides, 'source': 'Pre-defined Table'})
