...
public class MoodImageController {
    ...
    public MoodImageController(AgnesImageService agnesImageService,
    ...
    public GenerateResponse moodPixel(@Valid @RequestBody GenerateRequest req) throws Exception {
        ...
        byte[] rawPng = agnesImageService.generateMoodImageBytes(text);
        long t1 = System.nanoTime();
        log.info("[mood-pixel] Agnes 返回原图 bytes={} 本阶段耗时 {} ms", rawPng.length, ms(t0, t1));
